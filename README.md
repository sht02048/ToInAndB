...
# Still love to code
투인앤비를 만들면서 가장 크게 느낀 점은 "개발은 재밌다"입니다. 두 가지 이유가 있습니다. 첫 번째는 무에서 유를 창조하는, 저의 흔적을 남기는 설렘이 있습니다. 두 번째는 개발하는 방법이 끊임없이 개선된다는 점입니다. 처음 제작할 당시와 지금 완성된 코드를 비교만 해봐도 구조가 완전히 달라지고 그로 인해 유지 보수성과 가독성이 향상되었습니다. 앞으로 리펙토링 및 타입 스크립트로 마이그레이션하면서 얼마나 더 효율적인 코드를 쓸 수 있을지 기대됩니다.
